    ...
    <header className={cn(
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={cn(
          ...
          <a href="#" className="flex items-center gap-3 group shrink-0" aria-label="OSARIS Ingénierie — accueil">
          ...
          <div className="flex items-center gap-5 shrink-0">
            ...
            <a href="#contact" className="group/cta hidden lg:inline-flex items-center gap-2 px-5 py-2.5 bg-brand-orange text-white font-display font-bold text-sm tracking-wide uppercase rounded-lg shadow-soft hover:bg-brand-orange-dark hover:shadow-card hover:-translate-y-0.5 transition-all duration-200">
              Demander une étude
        ...
        {menuOpen && (
          <div className="lg:hidden border-t border-night-700 py-5 bg-night-900/95 backdrop-blur-md">
            <nav className="flex flex-col gap-1">
              {navLinks.map((link) => (
                <a key={link.href} href={link.href} onClick={() => setMenuOpen(false)} className="font-mono text-xs tracking-widest uppercase text-night-200 hover:text-brand-orange hover:bg-night-850 rounded-md py-3 px-3 transition-colors duration-200">
                  {link.label}
                </a>
              ))}
              ...
              <a href="#contact" onClick={() => setMenuOpen(false)} className="mt-3 inline-flex items-center justify-center gap-2 px-5 py-3 bg-brand-orange text-white font-display font-bold text-sm tracking-wide uppercase rounded-lg shadow-soft">
                Demander une étude
