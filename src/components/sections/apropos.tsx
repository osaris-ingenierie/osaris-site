        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start mb-16">
          ...
          <div>
            ...
            <BlurFade delay={0.25} inView>
              <Link href="/contact" className="inline-flex items-center gap-2 text-brand-orange-dark font-display font-bold tracking-wide uppercase text-sm hover:gap-3 transition-all duration-200">
