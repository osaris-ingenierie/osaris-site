...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center pt-28 sm:pt-24 pb-20 overflow-hidden">
      ...
      <a href="#services" aria-label="Aller à la section services" className="hidden sm:flex absolute bottom-8 left-1/2 -translate-x-1/2 text-night-400 hover:text-brand-orange transition-colors duration-300">
