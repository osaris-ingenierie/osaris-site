            ...
            return (
              <BlurFade key={service.id} delay={i * 0.05} inView duration={0.4}>
                <Link
                  ...
                  className={cn(
                    "group flex flex-col bg-night-800 p-5 h-full rounded-xl border border-night-700 shadow-card hover:shadow-card-hover hover:border-brand-orange/30 hover:-translate-y-1 transition-all duration-300"
                  )}
                >
                  <div className="flex items-center justify-between mb-3.5">
                    <span className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-night-850 border border-night-700 text-night-300 group-hover:text-brand-orange group-hover:border-brand-orange/30 group-hover:bg-brand-orange/[0.06] transition-all duration-300">
                  ...
                  <h3 className="font-display font-bold text-lg text-night-100 group-hover:text-night-50 transition-colors mb-1.5 leading-snug">
                    {service.title}
                  </h3>
                  <p className="text-night-200 text-sm leading-relaxed mb-3 flex-1 line-clamp-3">
                    {service.desc}
                  </p>
                  ...
                  <span className="inline-flex items-center gap-1.5 font-mono text-[0.62rem] tracking-widest uppercase text-brand-orange-dark mt-auto">
                    En savoir plus
